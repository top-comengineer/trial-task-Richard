...
import { PubSubEvent, usePub } from "../../hook/usePubSub";
...
export function MoverIcon() {
  ...
  return (
    <span
      className="fixed bottom-6 left-[362px] z-10 cursor-pointer text-gray-500 opacity-60 hover:opacity-100"
      onMouseDown={() => {
...
export function SettingsIcon({
  ...
  return (
    <>
      <span
        className="fixed bottom-2 left-[362px] z-10 cursor-pointer text-gray-500 opacity-60 hover:opacity-100"
